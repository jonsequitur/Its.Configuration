...
// from: https://github.com/Azure/azure-sdk-for-net/
//
...
namespace Its.Configuration
{
    ...
    /// </summary>
    internal class AzureApplicationSettings : ISettingsSource
    {
        ...
        /// </returns>
        public string GetSerializedSetting(string name)
        {
            string value = null;
        ...
        public string Name
        {
            get
            {
                return "Azure application settings";
            }
        }
        ...
        public bool IsAvailable
        {
            get
            {
                return _getServiceSettingMethod != null;
            }
        }
    }
}
